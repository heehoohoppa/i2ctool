...
class bus(object):
    ...
    def addDevice(self, address, name, parttype):
        ...
        if parttype == "vr":
            self.devices.append(voltageRegulator(self.bus_number, address, name, parttype))
        else:
...
temp_bus = bus("131", "longstring")
temp_bus.addDevice("4c", "regulator", "vr")
temp_bus.addDevice("44", "otherthing", "meh")

dev = temp_bus.getDevice("4c")
print dev.get_vout([smw])
